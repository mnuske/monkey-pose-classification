...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('task', default='mpc', help='')
    self.parser.add_argument('--dataset', default='jde', help='jde')
    self.parser.add_argument('--exp_id', default='default')
    self.parser.add_argument('--test', action='store_true')
    self.parser.add_argument('--load_model', default='/home/matthias/monkey/monkey-pose-classification/model_final.pth',
    ...
    self.parser.add_argument('--class_names', default=['sitting', 'standing2legs', 'standing4legs', 'walking'],
                             help='names of classes to classify.')         
    # self.parser.add_argument('--video_path', default='/media/hdd2/matthias/monkey_vids/luk/luk_2021-08-27_M1-1_cam19415032/vid000.mp4',
    #                          help='')  
    # self.parser.add_argument('--bb_path', default='/media/hdd2/matthias/monkey_vids_output/luk/luk_2021-08-27_M1-1_cam19415032/vid000.mp4/results.txt',
    #                          help='')  
    # self.parser.add_argument('--video_path', default='/home/matthias/monkey/test_pose/trim_short_short.mp4',
    #                          help='')  
    # self.parser.add_argument('--bb_path', default='/home/matthias/monkey/test_pose/results.txt',
    #                          help='')  
    self.parser.add_argument('--video_path', default='/media/hdd2/matthias/monkey_vids/hum/hum_2021-09-21_M1-2_cam19415032/vid001.mp4',
                             help='')  
    self.parser.add_argument('--bb_path', default='/media/hdd2/matthias/monkey_vids_output/hum/hum_2021-09-21_M1-2_cam19415032/vid001.mp4/results.txt',
                             help='')  
    ...
    self.parser.add_argument('--output_root', type=str, default='../test_pose/out2/', help='expected output root path')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/media/hdd2/matthias/datasets/')
  ...
  def parse(self, args=''):
    ...
    """both set with default values: true and 5"""
    # if opt.trainval:
  ...
  def init(self, args=''):
    default_dataset_info = {
      'mpc': {'default_resolution': [256, 256], 'num_classes': 4,
                'mean': [0.485, 0.456, 0.406], 'std': [0.289, 0.274, 0.278],
                'dataset': 'mpc'},
    }
